...
var html = '<div id="videoc"><button id="capture-btn">Capture!</button><br><video autoplay id="video" width="640" height="480"></video>';
html += '<canvas id="canvas" style="display:none" width="640" height="480"></canvas></div>'

$('#capture-btn, #video').show();
...
var App = {
  ...
  saveDataUrlToImage: function () {
    ...
    var options = {
      ...
      url: 'http://powernote.cloudapp.net/upload.php'
    };
    ...
    $.ajax({
      ...
      success: function(response, textStatus, xhr) {
        ...
        if (response.status_code === 200) {
          ...
          $("#videoc").append("<img src='"+imageURL+"' width='640' height='480'><br>");
          $('#capture-btn, #video').hide();
